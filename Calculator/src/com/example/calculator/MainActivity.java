...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
        	...
        	int c=a+b;
        	Toast.makeText(getApplicationContext(),"addition:"+Integer.toString(c),Toast.LENGTH_LONG).show();
        	}
        	if(t3.getText().toString().equals("-"))
        	{
        	int a=Integer.parseInt(t1.getText().toString());
        	int b=Integer.parseInt(t2.getText().toString());
        	int c=a-b;
        	Toast.makeText(getApplicationContext(),"subtraction:"+Integer.toString(c),Toast.LENGTH_LONG).show();
        	}
        	if(t3.getText().toString().equals("*"))
        	{
        	int a=Integer.parseInt(t1.getText().toString());
        	...
        	int b=Integer.parseInt(t2.getText().toString());
        	int c=a/b;
        	Toast.makeText(getApplicationContext(),"Division:"+Integer.toString(c),Toast.LENGTH_LONG).show();
        	}
        	}
        	});
